...
class Car: 
	...
	def move(self):
		...
		if pressed_keys[pg.K_UP] and self.speed != 0 or self.output[0] < -0.75 and self.speed != 0:
			self.speed -= 0.14
		self.speed -= 0.03
		if pressed_keys[pg.K_DOWN] and self.speed != 0 or self.output[0] > 0.75 and self.speed != 0:
			self.speed += 0.14
...
def eval_genomes(genomes, config):
	...
	for genome_id, genome in genomes:
		...
		while running:
			...
			car.move()
			angles_to_check = [0, 30, 60, 80, 90, 100, 120, 150, 180]
